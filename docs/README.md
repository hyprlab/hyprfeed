...
| File | What is in it |
| --- | --- |
| [DOCUMENTATION.md](DOCUMENTATION.md) | Configuration, Turnstile, the page watcher, backups, running from source |
...
| Artwork for the README or the docs | `assets/`, never `docs/`, which holds Markdown only |
